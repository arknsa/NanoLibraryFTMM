              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content-center">
                    ...
                    <!-- Tombol Edit -->
                    <a href="{{ route('admin.peminjaman.edit', $item->ID_Peminjaman) }}" class="btn btn-outline-warning btn-sm me-2" title="Edit">
                      <i class="fas fa-edit"></i> Edit
                    </a>

                    <!-- Tombol Delete -->
                    <form action="{{ route('admin.peminjaman.destroy', $item->ID_Peminjaman) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data ini?');" style="display: inline;">
                      @csrf
                      @method('DELETE')
