        ...
        <div class="container">
            <div class="page-inner">
              <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                  <h3 class="fw-bold mb-3">Data Denda</h3>
                </div>
                <div class="ms-md-auto py-2 py-md-0">
                  <a href="#" class="btn btn-label-info btn-round me-2">Atur</a>
                  <a href="#" class="btn btn-primary btn-round">Tambah Denda</a>
                </div>
              </div>
              ...
              <div class="container-fluid py-5">
                  <div class="container">
                      <div class="table-responsive bg-white p-4 rounded shadow-sm">
                          <h2 class="mb-4 text-center">Data Denda Mahasiswa</h2>
                            <table id="dataDendaTable" class="table table-hover table-striped align-middle text-center">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      <td>2</td>
                                      <td>Franky</td>
                                      <td>franky-2022@ftmm.unair.ac.id</td>
                                      <td>085758596061</td>
                                      <td>19-09-2024</td>
                                      <td>6000</td>
                                      <td>Aktif</td>
                                  ...
                                  <tr>
                                      <td>3</td>
                                      <td>Brook</td>
                                      <td>brook-2021@ftmm.unair.ac.id</td>
                                      <td>082221201918</td>
                                      <td>01-09-2024</td>
                                      <td>24000</td>
                                      <td>Aktif</td>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="copyright">
              ...
              <a href="http://www.themekita.com">Kelompok 8</a>
            </div>
          </div>
        </footer>
      </div>
